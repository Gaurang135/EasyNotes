...
SYSTEM_PROMPT = (
    ...
    "If a TABLE FACTS block is provided, each line was computed in code over the COMPLETE "
    "table — use those exact numbers verbatim for the count/total/average asked; never "
    "recompute them from the excerpts.\n"
